...
def on_message_received(topic, payload):
    if 'request' not in payload.decode('utf-8') and 'set' not in payload.decode('utf-8'):
        print("*************************************")
        print("Received {} data from cloud : {}".format(topic, payload.decode('utf-8')))
        print("*************************************")
        global received_count
        if "request" in args.message:
            received_count += 1
...
if __name__ == '__main__':
    ...
    if args.message:
        ...
        while (publish_count <= args.count) or (args.count == 0):
            ...
            print("Publishing {} request to cloud: {}".format(args.topic, message))
